<template>
    ...
    <div>
        ...
        <div class="mb-6">
            <h1 class="text-xl font-semibold text-gray-700 mb-2">Versions</h1>
            <h2 class="text-sm text-gray-400">Select a version to build your app</h2>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            startSearch(search) {
                this.$inertia.get(route('app.show', { project: this.route().params.project, app: this.route().params.app }), { search: search, view: this.view }, {
                    preserveScroll: true,
                    preserveState: true,
                    replace: true
                });
