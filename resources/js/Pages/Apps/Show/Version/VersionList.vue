    ...
    <tr @click="showVersion" class="group border-b cursor-pointer hover:bg-gray-50">
        ...
        <td scope="row" class="p-4">
            ...
            <div class="flex justify-end opacity-0 group-hover:opacity-100">
                ...
                <CreateOrUpdateVersionModal :version="version" mode="Delete" :showButton="false" class="mr-2"></CreateOrUpdateVersionModal>

                <!-- Update Version Modal -->
                <CreateOrUpdateVersionModal :version="version" mode="Update" :showButton="false"></CreateOrUpdateVersionModal>
