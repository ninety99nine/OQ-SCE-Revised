    ...
    export default {
        ...
        methods: {
            ...
            saveChanges() {
                ...
                this.form.put(route('global.variable.update', { project: this.route().params.project, app: this.route().params.app, version: this.route().params.version, global_variable: this.route().params.global_variable }), {
                    preserveState: true,
                    preserveScroll: true,
                    onSuccess: () => {
                        self.$message({
