<template>
    ...
    <DefaultModal defaultText="Cancel"
        ...
        :dangerText="mode == 'Delete' ? mode + ' Version' : ''" :dangerAction="handleAction"
        :primaryText="['Create', 'Update'].includes(mode) ? (mode == 'Create' ? mode + ' Version' : 'Save Changes') : ''" :primaryAction="handleAction">
