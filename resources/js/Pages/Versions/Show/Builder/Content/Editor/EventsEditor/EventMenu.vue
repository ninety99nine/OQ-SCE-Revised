<template>
    ...
    <div :class="['group-2 rounded-md border', (active ? 'shadow-sm border-2 my-4' : 'mb-2')]" :style="{ borderLeftColor: event.hexColor, borderLeftWidth: '4px' }">
        ...
        <div @click="toggleSelection()" :class="['grid grid-cols-12 text-xs text-gray-700 py-2 px-4 cursor-pointer', active ? 'border-b border-dashed bg-blue-50 rounded-tr-md' : 'bg-gray-50 rounded-r-md']" :style="{ backgroundColor: event.hexColor+'05',  }">
            ...
            <div class="col-span-6 flex justify-end items-center relative">
                ...
                <div class="flex items-center text-gray-400 text-xs transition-all duration-300 opacity-100 group-2-hover:opacity-0">
                ...
                <div class="absolute right-8 flex items-center justify-end transition-all duration-300 opacity-0 group-2-hover:opacity-100">
