<template>
    ...
    <div :class="['rounded-md border', (active ? 'shadow-sm border-2 my-4' : 'mb-2')]" :style="{ borderLeftColor: navigation.hexColor, borderLeftWidth: '4px' }">
        ...
        <div @click="toggleSelection()" :class="['grid grid-cols-12 group text-xs text-gray-700 py-2 px-4 cursor-pointer', active ? 'border-b border-dashed bg-blue-50 rounded-tr-md' : 'bg-gray-50 rounded-r-md']" :style="{ backgroundColor: navigation.hexColor+'05',  }">
