<template>
    ...
    <DefaultModal
        ...
        <!-- Screen Selector -->
        <ScreenOrDisplaySelector v-model="form[this.form.selected_type].link" label="Navigation Target" info="Screen to trigger navigaition" :showDisplays="false" :error="form.errors.link" class="mb-6"></ScreenOrDisplaySelector>
