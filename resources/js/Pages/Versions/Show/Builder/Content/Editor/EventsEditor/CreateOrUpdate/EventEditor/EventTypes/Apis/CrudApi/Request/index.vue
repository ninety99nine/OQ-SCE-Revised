<template>
    ...
    <div>
        ...
        <div class="grid grid-cols-2 gap-4 items-center">
            ...
            <div v-if="form.event_data.cache.enabled" class="col-span-1 flex mb-6">
            ...
            <DefaultInput v-model="form.event_data.cache.name" :error="form.errors.cache_name"></DefaultInput>
