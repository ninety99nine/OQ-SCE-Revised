                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <draggable
                        ...
                        <template #item="{element, index}">
                            <tr v-if="searchIndexes.includes(index)" class="group border-b hover:bg-gray-50">
...
<script>
    ...
    export default {
        props: ['form'],
        components: { draggable, DefaultError, TextEditor, CodeEditor, HiddenCode, DefaultSearchBar, CreateOrUpdateParamModal, DangerButton, DefaultSwitch, DeleteParamModal },
        data(){
            return {
                headers: ['Name', 'Value'],
