<template>
    <div>
        <WarningAlert v-if="read_only" class="mt-2 mb-2 pb-2 border-b border-dotted">
        ...
        <CodeEditor
            v-model="localModelValue" :value="localModelValue" :wrap_code="wrap_code" :read_only="read_only" :autofocus="autofocus"
