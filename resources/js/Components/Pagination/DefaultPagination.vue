            ...
            <ul class="inline-flex items-center -space-x-px text-xs">
                <template v-for="link in pagination.links" :key="link.label">
                    ...
                    <li v-if="link.label === 'Previous'">
                        <component :is="link.url ? 'a' : 'span'" :href="link.url" class="block py-3 px-3 ml-0 leading-tight text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700">
                    ...
                    <li v-else-if="link.label === 'Next'">
                        <component :is="link.url ? 'a' : 'span'" :href="link.url" class="block py-3 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700">
                    ...
                    <li v-else-if="link.active == true">
                        <a :href="link.url" aria-current="page" class="z-10 py-3 px-3 leading-tight text-blue-600 bg-blue-50 border border-blue-300 hover:bg-blue-100 hover:text-blue-700">
                            {{ link.label }}
                        </a>
                    </li>
                    ...
                    <li v-else-if="link.active == false">
                        <a :href="link.url" class="py-3 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700">
                            {{ link.label }}
                        </a>
                    </li>
