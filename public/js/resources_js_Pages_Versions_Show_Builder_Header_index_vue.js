  ...
  methods: {
    ...
    uploadToRepairFile: function uploadToRepairFile(builderForRepair, closeModal) {
      ...
      axios.post(url, formData, config).then(function (response) {
        //  Get the builder
        var builder = response.data; //  Update the project version builder

        self.useVersionBuilder.setBuilder(builder); //  Select a screen by default

        _this2.useVersionBuilder.selectRecomendedScreen(); //  Indicate that the builder has been imported
...
/* harmony import */ var _BackButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BackButton */ "./resources/js/Pages/Versions/Show/Builder/Header/BackButton.vue");
/* harmony import */ var _inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @inertiajs/inertia-vue3 */ "./node_modules/@inertiajs/inertia-vue3/dist/index.js");
/* harmony import */ var _components_Error_DefaultError__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @components/Error/DefaultError */ "./resources/js/Components/Error/DefaultError.vue");
/* harmony import */ var _components_Alert_WarningAlert__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @components/Alert/WarningAlert */ "./resources/js/Components/Alert/WarningAlert.vue");
...
/* harmony import */ var _ImportVersion_ImportVersionModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ImportVersion/ImportVersionModal */ "./resources/js/Pages/Versions/Show/Builder/Header/ImportVersion/ImportVersionModal.vue");
/* harmony import */ var _ExportVersion_ExportVersionModal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ExportVersion/ExportVersionModal */ "./resources/js/Pages/Versions/Show/Builder/Header/ExportVersion/ExportVersionModal.vue");
/* harmony import */ var _components_ProgressBar_DefaultProgressBar__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @components/ProgressBar/DefaultProgressBar */ "./resources/js/Components/ProgressBar/DefaultProgressBar.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    DefaultError: _components_Error_DefaultError__WEBPACK_IMPORTED_MODULE_3__["default"],
    WarningAlert: _components_Alert_WarningAlert__WEBPACK_IMPORTED_MODULE_4__["default"],
    ...
    ImportVersionModal: _ImportVersion_ImportVersionModal__WEBPACK_IMPORTED_MODULE_8__["default"],
    ExportVersionModal: _ExportVersion_ExportVersionModal__WEBPACK_IMPORTED_MODULE_9__["default"],
    DefaultProgressBar: _components_ProgressBar_DefaultProgressBar__WEBPACK_IMPORTED_MODULE_10__["default"]
  },
  data: function data() {
    return {
  ...
  computed: {
    error: function error() {
      return this.form.errors.number || this.form.errors.description || this.form.errors.builder || this.form.errors.reset_builder || this.form.errors.delete_code;
    }
  },
  methods: {
    ...
    updateVersion: function updateVersion() {
      ...
      this.isSaving = true; //  Start the conversation
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, formData, config).then(function (response) {
        ...
        _this2.useVersionBuilder.selectRecomendedScreen(); //  Turn off indication that the builder has been imported
    ...
    downloadVersion: function downloadVersion() {
      ...
      this.isDownloading = true; //  Start the conversation
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(url, config).then(function (response) {
        ...
        var builder = response.data; //  Store the version builder as the stored state builder

        _this3.useVersionBuilder.setBuilder(builder); //  Select a screen by default
    ...
    resetRequest: function resetRequest() {
      ...
      this.progressPercentage = null;
      clearInterval(this.downloadInSecondsInterval); //  Indicate that the builder has been saved

      this.useVersionBuilder.hasSavedBuilder = true; //  Indicate that the builder has been downloaded
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.width) + "%", 5
  /* TEXT, STYLE */
  )]);
}
...
var _hoisted_1 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Export Version");
...
}, "Project File"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" will download a JSON File that can be imported into a different project ")], -1
/* HOISTED */
);
...
var _hoisted_4 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Export ");
...
var _hoisted_22 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, "Cancel", -1
/* HOISTED */
);
...
var _hoisted_25 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, "Import", -1
/* HOISTED */
);
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      /* STABLE_FRAGMENT */
        ...
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          ...
          /* PROPS */
          , ["width"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_20, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      ...
      /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */
      )), $data.error ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultError, {
        key: 2,
        error: $data.error,
        "class": "mt-2"
      }, null, 8
...
var _hoisted_1 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" This builder has not been saved. Please "), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
  "class": "font-semibold text-blue-500"
}, "Save Changes"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" so that the simulator can reflect the imported changes. Then again you could refresh the browser to omit the imported changes. ")], -1
/* HOISTED */
);
...
var _hoisted_5 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Editor ");
...
var _hoisted_7 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Simulator ");
...
var _hoisted_10 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Save Changes");
...
var _hoisted_15 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, "Cancel", -1
/* HOISTED */
);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["disabled"])), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Simulator Button "), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDynamicComponent)($props.showEditor == false ? 'PrimaryButton' : 'DefaultButton'), {
  ...
  /* PROPS */
  , ["disabled"]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(vue__WEBPACK_IMPORTED_MODULE_0__.Transition, {
    name: "fade"
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [!$data.isSaving && !$data.isDownloading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Import Button "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ImportVersionModal, {
        form: $data.form
      }, null, 8
      /* PROPS */
      , ["form"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Export Button "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ExportVersionModal, {
        form: $data.form
      }, null, 8
      /* PROPS */
  ...
  /* PROPS */
  , ["disabled"])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Saving Progress "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(vue__WEBPACK_IMPORTED_MODULE_0__.Transition, {
    name: "fade"
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [$data.isSaving == true && $data.progressPercentage !== null ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Saving Progress Bar "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_DefaultProgressBar, {
        width: $data.progressPercentage
      }, null, 8
      /* PROPS */
      , ["width"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_13, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Saving Conversation "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(vue__WEBPACK_IMPORTED_MODULE_0__.Transition, {
        name: "fade",
        mode: "out-in",
        appear: ""
      }, {
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          ...
          }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.stillLoadingConversation), 1
          /* TEXT */
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [$data.isDownloading == true && $data.downloadInSeconds >= 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_17, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Downloading Progress Bar "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_DefaultProgressBar, {
        width: $data.progressPercentage
      }, null, 8
      /* PROPS */
      , ["width"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_19, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Downloading Conversation "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(vue__WEBPACK_IMPORTED_MODULE_0__.Transition, {
        name: "slide-up",
        mode: "out-in",
        appear: ""
      }, {
