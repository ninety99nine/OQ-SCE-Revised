"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_babel-loader_lib_index_js_clonedRuleSet-5_use_0_node_modules_vue-loader_dist_ind-e9bbd6"],{
...
/* harmony import */ var _CopyProperties_CopyPropertiesModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../CopyProperties/CopyPropertiesModal */ "./resources/js/Pages/Versions/Show/Builder/Content/Editor/ScreenEditor/CopyProperties/CopyPropertiesModal.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    CopyPropertiesModal: _CopyProperties_CopyPropertiesModal__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      properties: [{
  ...
  methods: {
    ...
    copyProperties: function copyProperties(closeModal) {
      ...
      var screenProperties = this.properties.filter(function (property) {
        return property.selected;
      }).map(function (property) {
        return _this.screen[property.value];
      });
